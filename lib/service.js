...
class Service extends Component.mixin(AsyncEmitter) {
    ...
    constructor(config, logger, injector) {
        ...
        this._express.use(bodyParser.json({limit: config.default("service.payload_limit", "2mb")}));
    ...
    *handleShutdown() {
        ...
        signals.forEach((signal) =>
            process.addListener(signal, () => {
                ...
                this.logger.info('Received kill signal', signal);
                this.logger.info('Shutting down api components');
